const upgrades = {
    normal: {
        ...
        9: {
            ...
            desc: "Increase ore duplication stack limit<br/>(Chance is halved for each duplication)",
            effect: x => x + 1,
        ...
        15: {
            ...
            effect: x => 0.005 * x,
            effectDisplay: x => formatWhole(x * 100, 1) + "%",
        ...
        19: {
            ...
            desc: "Every artifact used in a tool gives bonus gilding effect (separate from multi)",
            effect: x => 0.5 * x,
